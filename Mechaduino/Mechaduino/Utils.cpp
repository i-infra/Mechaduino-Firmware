...
void setupTCInterrupts() {  // configure the controller interrupt
  ...
  WAIT_TC16_REGS_SYNC(TC4)
  TC4->COUNT16.CC[0].reg = (int)(round(48000000 / (MOVE_CTRL_HZ))); // clock speed / freq = tick check
  WAIT_TC16_REGS_SYNC(TC4)
